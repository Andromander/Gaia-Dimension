...
public class NullFuelCategory extends PurifierRecipeCategory<NullFuelRecipe> {
    ...
    public NullFuelCategory(IGuiHelper guiHelper) {
        ...
        staticFlame = guiHelper.drawableBuilder(FLAME, 0, 0, 14, 14)
                ...
                .build();
        localizedName = Component.translatable("gui.gaiadimension.category.null_fuel");
    ...
    @Override
    public RecipeType<NullFuelRecipe> getRecipeType() {
        return GaiaRecipeTypes.NULLING;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder layout, NullFuelRecipe recipe, IFocusGroup focus) {
        layout.addSlot(RecipeIngredientRole.INPUT, 1, 17).addItemStacks(recipe.getInputs());
    }

    @Override
    public void draw(NullFuelRecipe recipe, IRecipeSlotsView view, GuiGraphics graphics, double mouseX, double mouseY) {
