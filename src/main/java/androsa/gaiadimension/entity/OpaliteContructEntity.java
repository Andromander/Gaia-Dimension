...
public class OpaliteContructEntity extends PathfinderMob {
    ...
    public static boolean canSpawnHere(EntityType<OpaliteContructEntity> entity, LevelAccessor world, MobSpawnType spawn, BlockPos pos, Random random) {
    ...
    protected InteractionResult mobInteract(Player player, InteractionHand hand) {
        if (player.getItemInHand(hand).getItem() != ModItems.construct_charm.get()) {
            String output = this.getMookaiteCompanion() != null ? this.getMookaiteCompanion().toString() : "No companion set";
