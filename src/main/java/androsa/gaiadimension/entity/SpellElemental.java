...
public class SpellElemental extends PathfinderMob {

    public SpellElemental(EntityType<? extends SpellElemental> entity, Level world) {
        super(entity, world);
        this.xpReward = 5;
    }
    ...
    public static boolean canSpawnHere(EntityType<SpellElemental> entity, LevelAccessor world, EntitySpawnReason spawn, BlockPos pos, RandomSource random) {
