...
public class GDLesserSpitfire extends EntityMob implements ISpitfireMob, IMob {
    ...
    protected void initEntityAI() {
        //this.tasks.addTask(4, new EntityBlaze.AIFireballAttack(this)); Replace with single fireball, like a Ghast
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityLiving.class, 10, false, true, (Predicate<EntityLiving>) entity -> entity != null && entity instanceof IShockshooterMob));
    }
    ...
    */
    ...
    public boolean getCanSpawnHere() {
        ...
        return world.getBlockState(blockpos.down()).getBlock() == GDBlocks.glitter_grass &&
                ...
                world.getBiome(new BlockPos(this)) == GDBiomes.volcaniclands;
    }
