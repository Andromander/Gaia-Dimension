...
public class LesserSpitfire extends Monster implements ISpitfireMob {

    public LesserSpitfire(EntityType<? extends LesserSpitfire> entity, Level worldIn) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Monster.class, 10, false, true, (entity, level) -> entity instanceof IShockshooterMob));
    }
    ...
    public static boolean canSpawnHere(EntityType<LesserSpitfire> entity, ServerLevelAccessor world, EntitySpawnReason spawn, BlockPos pos, RandomSource random) {
