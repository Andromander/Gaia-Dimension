...
public class ContortedNagaEntity extends Monster {
    ...
    public static boolean canSpawnHere(EntityType<ContortedNagaEntity> entity, ServerLevelAccessor world, MobSpawnType spawn, BlockPos pos, RandomSource random) {
