...
public class MarkuzarPlant extends Mob {
    ...
    public static boolean canSpawnHere(EntityType<MarkuzarPlant> entity, LevelAccessor world, MobSpawnType spawn, BlockPos pos, RandomSource random) {
