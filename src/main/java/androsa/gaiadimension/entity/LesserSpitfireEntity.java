...
public class LesserSpitfireEntity extends Monster implements ISpitfireMob {

    public LesserSpitfireEntity(EntityType<? extends LesserSpitfireEntity> entity, Level worldIn) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Monster.class, 10, false, true, entity -> entity instanceof IShockshooterMob));
    }
    ...
    public static boolean canSpawnHere(EntityType<LesserSpitfireEntity> entity, ServerLevelAccessor world, MobSpawnType spawn, BlockPos pos, RandomSource random) {
