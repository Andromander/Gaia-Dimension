...
public class AncientLagrahk extends Monster {

    public AncientLagrahk(EntityType<? extends AncientLagrahk> entity, Level world) {
        super(entity, world);
        this.xpReward = 20;
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, RuggedLurmorus.class, false));
    }
    ...
    public static boolean canSpawnHere(EntityType<AncientLagrahk> entity, ServerLevelAccessor world, EntitySpawnReason spawn, BlockPos pos, RandomSource random) {
