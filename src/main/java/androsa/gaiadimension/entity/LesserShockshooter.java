...
public class LesserShockshooter extends Monster implements IShockshooterMob {

    public LesserShockshooter(EntityType<? extends LesserShockshooter> entity, Level worldIn) {
