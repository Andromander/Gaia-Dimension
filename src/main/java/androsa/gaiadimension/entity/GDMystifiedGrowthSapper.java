...
public class GDMystifiedGrowthSapper extends EntityCreature implements IAnimals {
    ...
    public static final ResourceLocation LOOT_TABLE = new ResourceLocation(GaiaDimension.MODID, "entities/mystified_sapper");

    public GDMystifiedGrowthSapper(World world) {
        super(world);
