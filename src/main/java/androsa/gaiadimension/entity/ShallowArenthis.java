...
public class ShallowArenthis extends WaterAnimal {
    ...
    public ShallowArenthis(EntityType<? extends ShallowArenthis> entity, Level worldIn) {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new ShallowArenthis.AIMoveRandom(this));
    }
    ...
    static class AIMoveRandom extends Goal {
        private final ShallowArenthis arenthis;

        public AIMoveRandom(ShallowArenthis entity) {
        ...
        public void tick() {
            ...
            } else if (this.arenthis.getRandom().nextInt(reducedTickDelay(50)) == 0 || !(this.arenthis.wasTouchingWater || this.arenthis.isInFluidType((entity, fluidType, height) -> this.arenthis.canSwimInFluidType(fluidType))) || !this.arenthis.hasMovementVector()) {
