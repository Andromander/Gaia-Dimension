...
public class MookaiteAreaEffect extends Entity implements TraceableEntity {
    private static final EntityDataAccessor<Float> DATA_RADIUS = SynchedEntityData.defineId(MookaiteAreaEffect.class, EntityDataSerializers.FLOAT);
