...
public class MookaiteAmmoEntity extends ThrowableItemProjectile {
    public MookaiteAmmoEntity(EntityType<? extends MookaiteAmmoEntity> entity, Level level) {
        super(entity, level);
    }

    public MookaiteAmmoEntity(Level level, LivingEntity entity) {
