 ...
 */
@OnlyIn(Dist.CLIENT)
public class LesserShockshooterModel extends EntityModel<LesserShockshooterEntity> {
    ...
    public LesserShockshooterModel() {
        ...
        this.legL = new RendererModel(this, 52, 0);
        ...
        this.neck = new RendererModel(this, 0, 14);
        this.neck.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.neck.addBox(-2.0F, -2.0F, -1.5F, 4, 2, 3, 0.0F);
        this.headpart = new RendererModel(this, 18, 19);
        ...
        this.armR = new RendererModel(this, 48, 15);
        ...
        this.capeM = new RendererModel(this, 0, 31);
        ...
        this.capeL = new RendererModel(this, 34, 30);
        ...
        this.earR = new RendererModel(this, 70, 15);
        ...
        this.capeR = new RendererModel(this, 34, 45);
    ...
    @Override
    public void setRotationAngles(LesserShockshooterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
