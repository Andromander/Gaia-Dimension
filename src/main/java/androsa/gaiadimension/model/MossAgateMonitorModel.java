...
public class MossAgateMonitorModel extends EntityModel<MossAgateMonitorRenderState> {
	...
	@Override
	public void setupAnim(MossAgateMonitorRenderState state) {
		...
		this.front_arm_left.yRot = Mth.cos(state.walkAnimationPos * 0.6662F) * 0.5F * state.walkAnimationSpeed + 0.3927F;
		this.front_arm_left.zRot = Mth.cos(state.walkAnimationPos * 0.6662F) * 0.25F * state.walkAnimationSpeed;
		this.front_arm_right.yRot = Mth.cos(state.walkAnimationPos * 0.6662F) * 0.5F * state.walkAnimationSpeed - 0.3927F;
		this.front_arm_right.zRot = Mth.cos(state.walkAnimationPos * 0.6662F) * 0.25F * state.walkAnimationSpeed;

		this.back_leg_left.yRot = Mth.cos(state.walkAnimationPos * 0.6662F + (float) Math.PI) * 0.5F * state.walkAnimationSpeed - 0.3927F;
		this.back_leg_left.zRot = Mth.cos(state.walkAnimationPos * 0.6662F + (float) Math.PI) * 0.25F * state.walkAnimationSpeed;
		this.back_leg_right.yRot = Mth.cos(state.walkAnimationPos * 0.6662F + (float) Math.PI) * 0.5F * state.walkAnimationSpeed + 0.3927F;
		this.back_leg_right.zRot = Mth.cos(state.walkAnimationPos * 0.6662F + (float) Math.PI) * 0.25F * state.walkAnimationSpeed;
