...
public class MarkuzarPlantModel extends EntityModel<MarkuzarPlantEntity> {
    ...
    @Override
    public void setRotationAngles(MarkuzarPlantEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
