...
public class BismuthUletrusModel<T extends BismuthUletrusEntity> extends SegmentedModel<T> {
    ...
    public BismuthUletrusModel() {
        ...
        this.upperLegR.addCuboid(-3.0F, -2.0F, -13.0F, 6, 9, 13, 0.0F);
        ...
        this.upperArmR.addCuboid(-5.0F, 0.0F, -3.0F, 7, 12, 8, 0.0F);
        ...
        this.upperLegL.addCuboid(-3.0F, -2.0F, -13.0F, 6, 9, 13, 0.0F);
        ...
        this.lowerArmL.addCuboid(0.0F, 0.0F, -2.0F, 7, 12, 6, 0.0F);
        ...
        this.backClawL_1.addCuboid(-3.0F, -3.0F, 0.0F, 6, 3, 3, 0.0F);
        ...
        this.pawL.addCuboid(-4.5F, 0.0F, -3.0F, 9, 9, 4, 0.0F);
        ...
        this.lowerJaw.addCuboid(-3.5F, 0.0F, -10.0F, 7, 4, 10, 0.0F);
        this.lowerLegR = new ModelRenderer(this, 62, 102);
        this.lowerLegR.setRotationPoint(0.1F, 2.1F, -12.7F);
        this.lowerLegR.addCuboid(-3.0F, -3.0F, -10.0F, 6, 7, 13, 0.0F);
        ...
        this.upperJaw.addCuboid(-4.5F, 0.0F, -14.0F, 9, 5, 14, 0.0F);
        this.head = new ModelRenderer(this, 40, 53);
        this.head.setRotationPoint(0.0F, 4.5F, -6.0F);
        this.head.addCuboid(-5.5F, -6.0F, -12.0F, 11, 12, 12, 0.0F);
        ...
        this.headPart1.addCuboid(-2.5F, -2.0F, 0.0F, 5, 3, 18, 0.0F);
        ...
        this.backClawL.addCuboid(-3.0F, -3.0F, 0.0F, 6, 3, 3, 0.0F);
        this.backPawR = new ModelRenderer(this, 131, 106);
        this.backPawR.setRotationPoint(0.0F, 2.5F, -9.5F);
        this.backPawR.addCuboid(-3.5F, -8.0F, -3.0F, 7, 10, 4, 0.0F);
        ...
        this.backPawL.addCuboid(-3.5F, -8.0F, -3.0F, 7, 10, 4, 0.0F);
        ...
        this.horn.addCuboid(-1.5F, -12.0F, -1.5F, 3, 13, 3, 0.0F);
        ...
        this.pawR.addCuboid(-4.5F, 0.0F, -3.0F, 9, 9, 4, 0.0F);
        ...
        this.headPart2.addCuboid(-2.5F, -2.0F, 0.0F, 5, 3, 18, 0.0F);
        ...
        this.clawsR.addCuboid(-3.0F, 0.0F, -3.0F, 8, 3, 2, 0.0F);
        this.lowerArmR = new ModelRenderer(this, 0, 85);
        this.lowerArmR.setRotationPoint(1.9F, 9.2F, 1.9F);
        this.lowerArmR.addCuboid(-7.0F, 0.0F, -2.0F, 7, 12, 6, 0.0F);
        ...
        this.sail.addCuboid(-0.5F, -18.0F, 0.0F, 1, 18, 32, 0.0F);
        ...
        this.neck.addCuboid(-5.0F, 0.0F, -10.0F, 10, 11, 10, 0.0F);
        ...
        this.clawsL.addCuboid(-3.0F, 0.0F, -3.0F, 8, 3, 2, 0.0F);
