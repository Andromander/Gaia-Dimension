 ...
 */
@OnlyIn(Dist.CLIENT)
public class BismuthUletrusModel<T extends BismuthUletrusEntity> extends SegmentedModel<T> {
    ...
    public BismuthUletrusModel() {
        ...
        this.lowerArmL.setPos(-1.9F, 9.2F, 1.9F);
        ...
        this.backClawL_1.setPos(0.0F, -7.6F, -2.7F);
        ...
        this.pawL.setPos(3.5F, 10.9F, 5.5F);
        ...
        this.lowerJaw.setPos(0.0F, 2.0F, -11.0F);
        ...
        this.headPart1.setPos(4.0F, -4.0F, -13.0F);
        ...
        this.backPawL.setPos(0.0F, 2.5F, -9.5F);
        ...
        this.horn.setPos(0.0F, -5.0F, -11.5F);
        ...
        this.pawR.setPos(-3.5F, 10.9F, 5.5F);
        ...
        this.headPart2.setPos(-4.0F, -4.0F, -13.0F);
        ...
        this.sail.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.neck.setPos(0.0F, 1.5F, 5.5F);
        ...
        this.clawsL.setPos(-1.0F, 9.0F, 1.7F);
...
//            this.tail1.offsetY = 0.4F;
            ...
            this.upperArmL.xRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount + 0.33161255787892263F;
            this.upperArmR.xRot = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 0.5F * limbSwingAmount + 0.33161255787892263F;

            this.upperLegL.xRot = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 0.5F * limbSwingAmount + 1.0471975511965976F;
            this.upperLegR.xRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount + 1.0471975511965976F;

            this.tail1.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount * 0.5F + -0.014660765716752367F;
            this.tail1.yRot -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F + -0.014660765716752367F;
            this.tail2.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount * 0.5F + -0.014660765716752367F;
            this.tail2.yRot -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F + -0.014660765716752367F;
            this.tail3.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount * 0.5F + -0.014660765716752367F;
            this.tail3.yRot -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F + -0.014660765716752367F;
            this.tail4.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount * 0.5F + -0.014660765716752367F;
            this.tail4.yRot -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F + -0.014660765716752367F;
        }
    }
}
