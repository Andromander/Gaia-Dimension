...
public class SpellElementModel<T extends SpellElementEntity> extends SegmentedModel<T> {
    ...
    public SpellElementModel() {
        ...
        this.head.addCuboid(-2.5F, -5.0F, -1.5F, 5, 5, 3, 0.0F);
        //right horn 1
        this.horn1R = new ModelRenderer(this, 52, 3);
        this.horn1R.setRotationPoint(-0.5F, -4.6F, 0.0F);
        this.horn1R.addCuboid(-3.0F, 0.0F, -0.5F, 3, 4, 1, 0.0F);
        ...
        this.horn2R.addCuboid(0.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
        ...
        this.horn1L.addCuboid(0.0F, 0.0F, -0.5F, 3, 4, 1, 0.0F);
        ...
        this.horn2L.addCuboid(-2.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
        ...
        this.elbowR.addCuboid(0.0F, -2.0F, -1.0F, 1, 2, 2, 0.0F);
        //right claw
        this.clawR = new ModelRenderer(this, 57, 11);
        this.clawR.setRotationPoint(-0.7F, 10.3F, 0.0F);
        this.clawR.addCuboid(-2.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
        ...
        this.scytheL.addCuboid(0.0F, 0.0F, -1.0F, 3, 11, 2, 0.0F);
        ...
        this.elbowL.addCuboid(0.0F, -2.0F, -1.0F, 1, 2, 2, 0.0F);
        //left claw
        this.clawL = new ModelRenderer(this, 0, 13);
        this.clawL.setRotationPoint(0.7F, 10.3F, 0.0F);
        this.clawL.addCuboid(0.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
        ...
        this.tip.addCuboid(-1.0F, 0.0F, 0.0F, 2, 4, 1, 0.0F);
        //right tip part
        this.tipR = new ModelRenderer(this, 6, 8);
        this.tipR.setRotationPoint(-0.5F, 0.0F, 0.0F);
        this.tipR.addCuboid(-2.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        this.tipL.addCuboid(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
