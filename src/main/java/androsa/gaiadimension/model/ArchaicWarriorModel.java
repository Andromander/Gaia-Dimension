...
public class ArchaicWarriorModel extends EntityModel<ArchaicWarriorEntity> {
    ...
    @Override
    public void setRotationAngles(ArchaicWarriorEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
