...
public class AgateGolemModel<T extends AgateGolemEntity> extends SegmentedModel<T> {
    ...
    public AgateGolemModel() {
        ...
        this.shoulderR.addCuboid(-9.0F, -3.0F, -3.0F, 9, 6, 6, 0.0F);
        ...
        this.facepartUpR.addCuboid(-3.5F, -7.0F, 0.0F, 6, 7, 3, 0.0F);
        ...
        this.stomach.addCuboid(-4.0F, 0.0F, 0.0F, 8, 8, 5, 0.0F);
        this.upperArmL = new ModelRenderer(this, 121, 17);
        this.upperArmL.setRotationPoint(8.0F, -6.0F, 3.0F);
        this.upperArmL.addCuboid(-1.0F, 0.0F, -1.5F, 3, 12, 3, 0.0F);
        ...
        this.lowerLegL.addCuboid(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
        ...
        this.headtop.addCuboid(-2.5F, -2.5F, -1.0F, 5, 5, 2, 0.0F);
        ...
        this.facepartLowR.addCuboid(-1.0F, 0.0F, 0.0F, 3, 6, 2, 0.0F);
        ...
        this.chin.addCuboid(-2.0F, -2.0F, 0.0F, 4, 4, 1, 0.0F);
        ...
        this.lowerArmL.addCuboid(-2.0F, 0.0F, -2.0F, 4, 13, 4, 0.0F);
        ...
        this.upperLegR.addCuboid(-2.5F, 0.0F, -2.5F, 5, 9, 5, 0.0F);
        ...
        this.shoulderL.addCuboid(0.0F, -3.0F, -3.0F, 9, 6, 6, 0.0F);
        ...
        this.facepartLowL.addCuboid(-2.0F, 0.0F, 0.0F, 3, 6, 2, 0.0F);
        ...
        this.facepartUpL.addCuboid(-2.5F, -7.0F, 0.0F, 6, 7, 3, 0.0F);
        ...
        this.lowarmTopL_1.addCuboid(0.0F, 0.0F, 0.0F, 4, 13, 2, 0.0F);
        ...
        this.lowarmLeftL.addCuboid(-2.0F, 0.0F, -2.0F, 2, 13, 4, 0.0F);
        ...
        this.fistR.addCuboid(0.0F, 0.0F, 0.0F, 3, 3, 3, 0.0F);
        ...
        this.lowarmLeftR.addCuboid(-2.0F, 0.0F, -2.0F, 2, 13, 4, 0.0F);
        ...
        this.lowarmRightR.addCuboid(-2.0F, 0.0F, -2.0F, 2, 13, 4, 0.0F);
        ...
        this.fistL.addCuboid(0.0F, 0.0F, 0.0F, 3, 3, 3, 0.0F);
        ...
        this.lowarmTopR_1.addCuboid(0.0F, 0.0F, 0.0F, 4, 13, 2, 0.0F);
        ...
        this.upperLegL.addCuboid(-2.5F, 0.0F, -2.5F, 5, 9, 5, 0.0F);
        ...
        this.lowarmRightL.addCuboid(-2.0F, 0.0F, -2.0F, 2, 13, 4, 0.0F);
        ...
        this.lowarmTopL.addCuboid(-2.0F, 0.0F, -2.0F, 4, 13, 2, 0.0F);
        ...
        this.lowerArmR.addCuboid(-2.0F, 0.0F, -2.0F, 4, 13, 4, 0.0F);
        ...
        this.neck.addCuboid(-2.0F, 0.0F, -4.0F, 4, 5, 4, 0.0F);
        ...
        this.chinpartL.addCuboid(-3.0F, 0.0F, 0.0F, 3, 8, 2, 0.0F);
        ...
        this.chinpartR.addCuboid(-3.0F, 0.0F, 0.0F, 3, 8, 2, 0.0F);
        ...
        this.upperArmR.addCuboid(-2.0F, 0.0F, -1.5F, 3, 12, 3, 0.0F);
        ...
        this.lowerLegL_1.addCuboid(-3.0F, 0.0F, -3.0F, 6, 10, 6, 0.0F);
        ...
        this.lowarmTopR.addCuboid(-2.0F, 0.0F, -2.0F, 4, 13, 2, 0.0F);
        ...
        this.face.addCuboid(-3.0F, -7.0F, -5.0F, 6, 8, 5, 0.0F);
        this.torso = new ModelRenderer(this, 38, 13);
        this.torso.setRotationPoint(0.0F, -9.0F, 0.0F);
        this.torso.addCuboid(-6.5F, 0.0F, 0.0F, 13, 8, 6, 0.0F);
