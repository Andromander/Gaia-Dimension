 ...
 */
@OnlyIn(Dist.CLIENT)
public class ContortedNagaModel<T extends ContortedNagaEntity> extends SegmentedModel<T> {
    ...
    public ContortedNagaModel() {
        this.texWidth = 128;
        this.texHeight = 64;
        this.decal2 = new ModelRenderer(this, 0, 29);
        this.decal2.setPos(2.3F, -5.0F, 0.0F);
        ...
        this.bodyTorso.setPos(0.0F, 9.0F, 1.9F);
        ...
        this.miniTendril1.setPos(-7.0F, 2.9F, 5.5F);
        ...
        this.tendril2.setPos(0.3F, 11.5F, -1.9F);
        ...
        this.bodyLower.setPos(0.0F, 11.0F, 1.1F);
        ...
        this.miniTendril2.setPos(-1.6F, 7.0F, 0.2F);
        ...
        this.miniTendril3.setPos(0.0F, 6.7F, 0.0F);
        ...
        this.lowerArmL.setPos(10.4F, 0.0F, 0.0F);
        ...
        this.decal1.setPos(0.5F, -4.8F, 0.0F);
        ...
        this.browR.setPos(-3.9F, -2.4F, -6.0F);
        ...
        this.bodyTop.setPos(0.0F, -8.0F, -8.0F);
        ...
        this.finger2.setPos(13.6F, -3.5F, -2.0F);
        ...
        this.finger1.setPos(13.6F, -0.5F, -2.0F);
        ...
        this.tendril3.setPos(0.0F, 9.5F, 1.0F);
        ...
        this.tailTop.setPos(0.0F, 8.8F, 0.4F);
        ...
        this.tooth1.setPos(2.7F, 0.6F, -5.5F);
        ...
        this.neck.setPos(0.0F, 0.0F, 5.3F);
        ...
        this.upperArmL.setPos(7.1F, 2.5F, 5.7F);
        ...
        this.tooth2.setPos(-2.7F, 0.6F, -4.5F);
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lowerJaw.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.1F + 0.15F;

        this.upperArmL.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount * 0.5F;
        this.upperArmL.yRot -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F - 0.3141592653589793F;

        this.tendril1.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F - 0.2565634000431664F;
        this.tendril2.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F + 0.9075712110370513F;
        this.tendril3.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F - 0.7155849933176751F;

        this.miniTendril1.zRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F + 0.9075712110370513F;
        this.miniTendril2.zRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F - 0.6108652381980153F;
        this.miniTendril3.zRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.025F) * 0.15F + 0.45378560551852565F;

        this.tailTop.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount;
        this.tailBottom.yRot = MathHelper.cos(limbSwing * 0.6662F) * 0.5F * limbSwingAmount;
    }
}
