...
public class ContortedNagaModel<T extends ContortedNagaEntity> extends SegmentedModel<T> {
    ...
    public ContortedNagaModel() {
        ...
        this.decal2.addCuboid(0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F);
        ...
        this.bodyTorso.addCuboid(-5.5F, 0.0F, 0.0F, 11, 13, 6, 0.0F);
        ...
        this.miniTendril1.addCuboid(-3.0F, 0.0F, -1.3F, 3, 8, 3, 0.0F);
        ...
        this.tendril2.addCuboid(-1.5F, 0.0F, 0.0F, 3, 11, 3, 0.0F);
        ...
        this.bodyLower.addCuboid(-4.0F, 0.0F, 0.0F, 8, 13, 5, 0.0F);
        ...
        this.tailBottom.addCuboid(-2.5F, -4.0F, 0.0F, 5, 4, 10, 0.0F);
        this.browL = new ModelRenderer(this, 114, 18);
        this.browL.setRotationPoint(3.9F, -2.4F, -6.0F);
        this.browL.addCuboid(-0.5F, 0.0F, 0.0F, 1, 2, 5, 0.0F);
        ...
        this.miniTendril2.addCuboid(-1.0F, 0.0F, -1.0F, 2, 7, 2, 0.0F);
        ...
        this.miniTendril3.addCuboid(-0.5F, 0.0F, -0.5F, 1, 6, 1, 0.0F);
        ...
        this.lowerArmL.addCuboid(0.0F, -5.0F, -2.9F, 14, 6, 6, 0.0F);
        ...
        this.decal1.addCuboid(0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F);
        ...
        this.browR.addCuboid(-0.5F, 0.0F, 0.0F, 1, 2, 5, 0.0F);
        ...
        this.bodyTop.addCuboid(-9.5F, 0.0F, 0.0F, 19, 10, 8, 0.0F);
        ...
        this.finger2.addCuboid(0.0F, -1.0F, -1.0F, 6, 2, 2, 0.0F);
        ...
        this.head.addCuboid(-3.5F, -4.0F, -7.1F, 7, 7, 7, 0.0F);
        ...
        this.finger1.addCuboid(0.0F, -1.0F, -1.0F, 6, 2, 2, 0.0F);
        ...
        this.tendril3.addCuboid(-1.0F, 0.0F, 0.0F, 2, 10, 2, 0.0F);
        ...
        this.tailTop.addCuboid(-3.5F, 0.0F, 0.0F, 7, 5, 12, 0.0F);
        ...
        this.tooth1.addCuboid(-0.5F, -4.0F, -0.5F, 1, 4, 1, 0.0F);
        ...
        this.neck.addCuboid(-3.0F, -5.0F, -5.0F, 6, 5, 5, 0.0F);
        ...
        this.upperArmL.addCuboid(0.0F, -2.5F, -2.5F, 14, 4, 4, 0.0F);
        ...
        this.tooth2.addCuboid(-0.5F, -3.0F, -0.5F, 1, 3, 1, 0.0F);
