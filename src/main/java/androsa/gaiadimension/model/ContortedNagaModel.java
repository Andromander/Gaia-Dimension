 ...
 */
@OnlyIn(Dist.CLIENT)
public class ContortedNagaModel extends EntityModel<ContortedNagaEntity> {
    public RendererModel bodyTop;
    public RendererModel bodyTorso;
    public RendererModel upperArmL;
    public RendererModel tendril1;
    public RendererModel neck;
    public RendererModel miniTendril1;
    public RendererModel bodyLower;
    public RendererModel tailTop;
    public RendererModel tailBottom;
    public RendererModel lowerArmL;
    public RendererModel finger1;
    public RendererModel finger2;
    public RendererModel decal1;
    public RendererModel decal2;
    public RendererModel tendril2;
    public RendererModel tendril3;
    public RendererModel head;
    public RendererModel lowerJaw;
    public RendererModel upperJaw;
    public RendererModel browL;
    public RendererModel browR;
    public RendererModel tooth1;
    public RendererModel tooth2;
    public RendererModel miniTendril2;
    public RendererModel miniTendril3;

    public ContortedNagaModel() {
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.decal2 = new RendererModel(this, 0, 29);
        ...
        this.bodyTorso = new RendererModel(this, 54, 0);
        ...
        this.miniTendril1 = new RendererModel(this, 0, 18);
        ...
        this.tendril2 = new RendererModel(this, 110, 32);
        ...
        this.bodyLower = new RendererModel(this, 12, 18);
        ...
        this.miniTendril2 = new RendererModel(this, 0, 37);
        ...
        this.miniTendril3 = new RendererModel(this, 46, 0);
        ...
        this.lowerArmL = new RendererModel(this, 70, 32);
        ...
        this.decal1 = new RendererModel(this, 72, 19);
        ...
        this.browR = new RendererModel(this, 38, 22);
        ...
        this.finger2 = new RendererModel(this, 64, 19);
        ...
        this.head = new RendererModel(this, 22, 36);
        ...
        this.finger1 = new RendererModel(this, 33, 18);
        ...
        this.tendril3 = new RendererModel(this, 14, 36);
        ...
        this.tailTop = new RendererModel(this, 38, 19);
        ...
        this.tooth1 = new RendererModel(this, 0, 0);
        ...
        this.neck = new RendererModel(this, 104, 8);
        ...
        this.upperArmL = new RendererModel(this, 88, 0);
        ...
        this.tooth2 = new RendererModel(this, 4, 0);
    ...
    @Override
    public void setRotationAngles(ContortedNagaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
