...
public class CrystalGolemModel<T extends CrystalGolemEntity> extends SegmentedModel<T> {
    ...
    public CrystalGolemModel() {
        ...
        this.handR.setPos(-2.0F, 11.0F, 0.1F);
        ...
        this.backpart2.setPos(4.0F, 0.0F, 1.2F);
        ...
        this.backpart1.setPos(-4.0F, 0.0F, 1.2F);
        ...
        this.lowerArmR.setPos(-1.0F, 9.6F, -0.1F);
        ...
        this.faceR.setPos(1.8F, -6.5F, -2.4F);
        ...
        this.handL.setPos(2.0F, 11.0F, 0.1F);
        ...
        this.upperArmR.setPos(-6.5F, -7.5F, 0.0F);
        ...
        this.upperArmL.setPos(6.5F, -7.5F, 0.0F);
        ...
        this.faceT.setPos(0.0F, -7.8F, -4.7F);
        ...
        this.shoulderR.setPos(6.3F, -0.2F, 0.0F);
        ...
        this.thumbR.setPos(1.5F, 11.0F, 0.0F);
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.upperArmR.zRot += MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.2F;
        this.upperArmL.zRot -= MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.2F;
