 ...
 */
@OnlyIn(Dist.CLIENT)
public class NomadicLagrahkModel extends EntityModel<NomadicLagrahkEntity> {
    ...
    public RendererModel faceplateMid;
    public RendererModel faceplateL;
    public RendererModel faceplateR;
    ...
    public NomadicLagrahkModel() {
        ...
        this.tail4 = new RendererModel(this, 113, 42);
        ...
        this.hand2 = new RendererModel(this, 98, 78);
        ...
        this.faceplateL = new RendererModel(this, 30, 77);
        ...
        this.upperArm1 = new RendererModel(this, 120, 61);
        ...
        this.faceplateR = new RendererModel(this, 0, 80);
        ...
        this.tail1 = new RendererModel(this, 65, 92);
        ...
        this.toeR = new RendererModel(this, 82, 0);
        ...
        this.faceplateMid = new RendererModel(this, 63, 66);
        ...
        this.toeL = new RendererModel(this, 0, 0);
        ...
        this.tail3 = new RendererModel(this, 100, 92);
        ...
        this.tail2 = new RendererModel(this, 0, 103);
        ...
        this.lowerArm2 = new RendererModel(this, 45, 100);
        ...
        this.lowerArm1 = new RendererModel(this, 0, 80);
        ...
        this.hand1 = new RendererModel(this, 60, 77);
        ...
        this.footR = new RendererModel(this, 107, 0);
        ...
        this.teeth = new RendererModel(this, 98, 66);
    ...
    @Override
    public void setRotationAngles(NomadicLagrahkEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
