...
public class CavernTickModel<T extends CavernTickEntity> extends SegmentedModel<T> {
    ...
    public CavernTickModel() {
        ...
        this.body.addCuboid(-2.5F, 0.0F, 0.0F, 5, 4, 7, 0.0F);
        this.spike1 = new ModelRenderer(this, 0, 11);
        this.spike1.setRotationPoint(0.0F, 0.0F, 1.5F);
        this.spike1.addCuboid(-1.0F, 0.0F, 0.0F, 2, 1, 5, 0.0F);
        ...
        this.horn.addCuboid(-0.5F, 0.0F, -3.0F, 1, 1, 3, 0.0F);
        ...
        this.spike3.addCuboid(-1.0F, 0.0F, 0.0F, 2, 1, 5, 0.0F);
        ...
        this.spike2.addCuboid(-1.0F, 0.0F, 0.0F, 2, 1, 5, 0.0F);
        ...
        this.head.addCuboid(-2.0F, -2.0F, -2.0F, 4, 3, 2, 0.0F);
