...
public class CavernTickModel<T extends CavernTickEntity> extends SegmentedModel<T> {
    ...
    public CavernTickModel() {
        ...
        this.spike1.setPos(0.0F, 0.0F, 1.5F);
        ...
        this.horn.setPos(0.0F, -1.5F, -1.0F);
        ...
        this.spike3.setPos(1.5F, 0.5F, 2.0F);
        ...
        this.spike2.setPos(-1.5F, 0.5F, 2.0F);
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.spike1.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.05F) * 0.1F + 0.7853981633974483F;
        this.spike2.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.05F) * 0.1F + 0.7853981633974483F;
        this.spike3.xRot = MathHelper.sin(ageInTicks * (float)Math.PI * 0.05F) * 0.1F + 0.7853981633974483F;
