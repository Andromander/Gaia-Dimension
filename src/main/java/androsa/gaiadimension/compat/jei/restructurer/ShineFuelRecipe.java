...
public class ShineFuelRecipe implements IRecipeWrapper {
    private final List<List<ItemStack>> inputs;
    private final String smeltCountString;
    private final IDrawableAnimated flame;
    private final ResourceLocation firetex = new ResourceLocation(GaiaDimension.MODID, "textures/gui/jei/shining.png");

    public ShineFuelRecipe(IGuiHelper guiHelper, Collection<ItemStack> input, int burnTime) {
