...
public class RestructuringCategory extends RestructurerRecipeCategory<RestructurerRecipe> {
    ...
    public RestructuringCategory(IGuiHelper guiHelper) {
        ...
        localizedName = new TranslatableComponent("gui.gaiadimension.category.restructuring");
    }
    ...
    @Override
    public void draw(RestructurerRecipe recipe, PoseStack stack, double mouseX, double mouseY) {
