...
public class CappedFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<CappedFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec((obj) ->
    ...
    @Override
    protected void createFoliage(WorldGenLevel reader, FoliageSetter leaves, RandomSource random, TreeConfiguration config, int height, FoliageAttachment attachment, int foliageheight, int trunkheight, int offset) {
