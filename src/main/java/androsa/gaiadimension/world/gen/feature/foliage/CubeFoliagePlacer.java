...
public class CubeFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<CubeFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec((instance) ->
    ...
    @Override
    protected void createFoliage(WorldGenLevel reader, FoliageSetter leaves, RandomSource random, TreeConfiguration config, int height, FoliageAttachment attachment, int foliageheight, int radius, int offset) {
