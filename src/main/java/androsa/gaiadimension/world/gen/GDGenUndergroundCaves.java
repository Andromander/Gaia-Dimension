...
public class GDGenUndergroundCaves extends MapGenCaves {
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D) {
                                    for (int caveY = minY - 1; caveY >= maxY; --caveY) {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 20.0D) {
                                            ...
                                            if (blockAt instanceof GDGaiaGrass || blockAt == GDBlocks.corrupt_grass) {
                                                hitGrass = true;
                                            }
    ...
    protected void recursiveGenerate(World par1World, int genX, int genZ, int centerX, int centerZ, @Nullable ChunkPrimer blockStorage) {
        ...
        for (int i = 0; i < numberOfCaves; ++i) {
            ...
            double randY = (double) this.rand.nextInt(this.rand.nextInt(25) + 8);
