...
public class GDGenBismuthBog extends WorldGenerator {
                ...
                for (int l2 = 0; l2 < 16; ++l2) {
                    for (int k = 0; k < 8; ++k) {
                        ...
                        if (flag) {
                            ...
                            if (k < 4 && !material.isSolid() && worldIn.getBlockState(position.add(k1, k, l2)).getBlock() != GDBlocks.liquid_bismuth_block) {
                                return false;
                            }
                        }
                    }
                ...
                for (int i3 = 0; i3 < 16; ++i3) {
                    for (int i4 = 0; i4 < 8; ++i4) {
                        if (aboolean[(l1 * 16 + i3) * 8 + i4]) {
                            worldIn.setBlockState(position.add(l1, i4, i3), i4 >= 4 ? Blocks.AIR.getDefaultState() : GDBlocks.liquid_bismuth_block.getDefaultState(), 2);
                        }
                    }
                }
            }
                ...
                for (int k3 = 0; k3 < 16; ++k3) {
                    for (int k4 = 0; k4 < 8; ++k4) {
                        ...
                        if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) {
                            if (rand.nextInt(4) == 0) {
                                worldIn.setBlockState(position.add(j2, k4, k3), GDBlocks.active_rock.getDefaultState(), 2);
                            } else {
                                worldIn.setBlockState(position.add(j2, k4, k3), GDBlocks.impure_rock.getDefaultState(), 2);
                            }
                        }
                    }
                }
