...
public class GaiaSurfaceRuleData {
    ...
    public static SurfaceRules.RuleSource gaia(boolean hasSeaLevel, boolean bedrockRoof, boolean bedrockFloor) {
        ...
        SurfaceRules.ConditionSource saltyBiomeCondition = SurfaceRules.isBiome(ModBiomes.salt_dunes, ModBiomes.mineral_river, ModBiomes.mineral_reservoir); //TODO: make salty beaches
                        ...
                        SurfaceRules.ifTrue(belowWaterCondition,
                                SurfaceRules.sequence(
                                        ...
                                        SurfaceRules.ifTrue(saltyBiomeCondition,
                                                SurfaceRules.ifTrue(SurfaceRules.stoneDepthCheck(0, true, true, CaveSurface.FLOOR), SALTSTONE)))),
                        SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR,
                                SurfaceRules.sequence(
