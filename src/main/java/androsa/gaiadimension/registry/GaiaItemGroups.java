...
public class GaiaItemGroups {
    ...
    public static void registerTabs(CreativeModeTabEvent.Register event) {
        //Tab for Blocks
        CreativeModeTab GAIA_BLOCKS = event.registerCreativeModeTab(new ResourceLocation(GaiaDimensionMod.MODID, "gaia_blocks"), builder -> builder
            .title(Component.translatable("itemGroup.gaiadimension.gaia_blocks"))
                ...
                .displayItems((parameters, output) -> {
                    ...
                    add(output, ModBlocks.heavy_soil, ModBlocks.corrupt_soil, ModBlocks.boggy_soil, ModBlocks.light_soil, ModBlocks.aurum_soil);
                    add(output, ModBlocks.glitter_grass, ModBlocks.corrupt_grass, ModBlocks.murky_grass, ModBlocks.soft_grass, ModBlocks.gilded_grass);
                    ...
                    add(output, ModBlocks.pink_agate_sapling, ModBlocks.blue_agate_sapling, ModBlocks.green_agate_sapling, ModBlocks.purple_agate_sapling, ModBlocks.fossilized_sapling, ModBlocks.corrupted_sapling, ModBlocks.burnt_sapling, ModBlocks.burning_sapling, ModBlocks.aura_sapling, ModBlocks.golden_sapling);
                    add(output, ModBlocks.pink_agate_leaves, ModBlocks.blue_agate_leaves, ModBlocks.green_agate_leaves, ModBlocks.purple_agate_leaves, ModBlocks.fossilized_leaves, ModBlocks.corrupted_leaves, ModBlocks.burnt_leaves, ModBlocks.burning_leaves, ModBlocks.aura_leaves, ModBlocks.golden_leaves);
                    add(output, ModBlocks.pink_agate_log, ModBlocks.blue_agate_log, ModBlocks.green_agate_log, ModBlocks.purple_agate_log, ModBlocks.fossilized_log, ModBlocks.corrupted_log, ModBlocks.burnt_log, ModBlocks.burning_log, ModBlocks.aura_log, ModBlocks.golden_log);
                    add(output, ModBlocks.stripped_pink_agate_log, ModBlocks.stripped_blue_agate_log, ModBlocks.stripped_green_agate_log, ModBlocks.stripped_purple_agate_log, ModBlocks.stripped_fossilized_log, ModBlocks.stripped_corrupted_log, ModBlocks.stripped_burnt_log, ModBlocks.stripped_burning_log, ModBlocks.stripped_aura_log, ModBlocks.stripped_golden_log);
                    add(output, ModBlocks.pink_agate_wood, ModBlocks.blue_agate_wood, ModBlocks.green_agate_wood, ModBlocks.purple_agate_wood, ModBlocks.fossilized_wood, ModBlocks.corrupted_wood, ModBlocks.burnt_wood, ModBlocks.burning_wood, ModBlocks.aura_wood, ModBlocks.golden_wood);
                    add(output, ModBlocks.stripped_pink_agate_wood, ModBlocks.stripped_blue_agate_wood, ModBlocks.stripped_green_agate_wood, ModBlocks.stripped_purple_agate_wood, ModBlocks.stripped_fossilized_wood, ModBlocks.stripped_corrupted_wood, ModBlocks.stripped_burnt_wood, ModBlocks.stripped_burning_wood, ModBlocks.stripped_aura_wood, ModBlocks.stripped_golden_wood);
                    ...
                    add(output, ModBlocks.speckled_rock, ModBlocks.coarse_rock, ModBlocks.precious_rock, ModBlocks.pyrite_ore, ModBlocks.sugilite_ore, ModBlocks.hematite_ore, ModBlocks.cinnabar_ore, ModBlocks.labradorite_ore, ModBlocks.moonstone_ore, ModBlocks.opal_ore_red, ModBlocks.opal_ore_blue, ModBlocks.opal_ore_green, ModBlocks.opal_ore_white);
                    add(output, ModBlocks.pink_agate_planks, ModBlocks.pink_agate_plank_stairs, ModBlocks.pink_agate_plank_slab);
                    add(output, ModBlocks.blue_agate_planks, ModBlocks.blue_agate_plank_stairs, ModBlocks.blue_agate_plank_slab);
                    add(output, ModBlocks.green_agate_planks, ModBlocks.green_agate_plank_stairs, ModBlocks.green_agate_plank_slab);
                    add(output, ModBlocks.purple_agate_planks, ModBlocks.purple_agate_plank_stairs, ModBlocks.purple_agate_plank_slab);
                    add(output, ModBlocks.fossilized_planks, ModBlocks.fossilized_plank_stairs, ModBlocks.fossilized_plank_slab);
                    add(output, ModBlocks.corrupted_planks, ModBlocks.corrupted_plank_stairs, ModBlocks.corrupted_plank_slab);
                    add(output, ModBlocks.burnt_planks, ModBlocks.burnt_plank_stairs, ModBlocks.burnt_plank_slab);
                    add(output, ModBlocks.burning_planks, ModBlocks.burning_plank_stairs, ModBlocks.burning_plank_slab);
                    add(output, ModBlocks.aura_planks, ModBlocks.aura_plank_stairs, ModBlocks.aura_plank_slab);
                    //TODO: Golden Planks
                    ...
                    add(output, ModBlocks.malachite_bricks, ModBlocks.malachite_cracked_bricks, ModBlocks.malachite_crusted_bricks, ModBlocks.malachite_chisel_bricks, ModBlocks.malachite_floor_tiles, ModBlocks.malachite_pillar);
                    add(output, ModBlocks.malachite_pulsing_bricks, ModBlocks.malachite_pulsing_chisel, ModBlocks.malachite_pulsing_tiles);
                    add(output, ModBlocks.malachite_brick_stairs, ModBlocks.malachite_cracked_brick_stairs, ModBlocks.malachite_crusted_brick_stairs, ModBlocks.malachite_floor_stairs, ModBlocks.malachite_chisel_stairs, ModBlocks.malachite_pillar_stairs);
                    ...
                    add(output, ModBlocks.malachite_brick_slab, ModBlocks.malachite_cracked_brick_slab, ModBlocks.malachite_crusted_brick_slab, ModBlocks.malachite_floor_slab);
                    add(output, ModBlocks.pyrite_block, ModBlocks.sugilite_block, ModBlocks.hematite_block, ModBlocks.cinnabar_block, ModBlocks.labradorite_block, ModBlocks.moonstone_block, ModBlocks.opal_block_red, ModBlocks.opal_block_blue, ModBlocks.opal_block_green, ModBlocks.opal_block_white);
        ...
        CreativeModeTab GAIA_ITEMS = event.registerCreativeModeTab(new ResourceLocation(GaiaDimensionMod.MODID, "gaia_items"), List.of(), List.of(GAIA_BLOCKS), builder -> builder
                ...
                .displayItems((parameters, output) -> {
                    ...
                    add(output, ModItems.pyrite, ModItems.sugilite, ModItems.hematite, ModItems.cinnabar, ModItems.labradorite, ModItems.moonstone, ModItems.red_opal, ModItems.blue_opal, ModItems.green_opal, ModItems.white_opal);
        ...
        CreativeModeTab GAIA_TOOLS = event.registerCreativeModeTab(new ResourceLocation(GaiaDimensionMod.MODID, "gaia_tools"), List.of(), List.of(GAIA_ITEMS), builder -> builder
        ...
        event.registerCreativeModeTab(new ResourceLocation(GaiaDimensionMod.MODID, "gaia_armor"), List.of(), List.of(GAIA_TOOLS), builder -> builder
