...
public class GDFluids {
    ...
    public static final Fluid liquidBismuth = new Fluid("liquid_bismuth", new ResourceLocation(GaiaDimension.MODID, "fluids/liquidbismuth/liquid_bismuth_still"),
            new ResourceLocation(GaiaDimension.MODID, "fluids/liquidbismuth/liquid_bismuth_flow"))
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        GDItems.liquid_bismuth_bucket_item = FluidUtil.getFilledBucket(new FluidStack(GDFluids.liquidBismuth, Fluid.BUCKET_VOLUME));
    }
}
