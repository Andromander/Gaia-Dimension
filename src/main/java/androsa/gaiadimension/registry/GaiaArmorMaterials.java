...
public enum GaiaArmorMaterials implements IArmorMaterial {
    SUGILITE("sugilite", 77, new int[]{1, 4, 6, 1}, 5, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0F, () -> Ingredient.fromItems(ModItems.sugilite.get())),
    PROUSTITE("proustite", 115, new int[]{1, 4, 6, 1}, 5, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0F, () -> Ingredient.fromItems(ModItems.proustite.get())),
    LEUCITE("leucite", 100, new int[]{1, 4, 6, 1}, 5, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1.0F, () -> Ingredient.fromItems(ModItems.leucite.get())),
    CARNELIAN("carnelian", 192, new int[]{2, 5, 7, 2}, 5, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.fromItems(ModItems.carnelian.get())),
