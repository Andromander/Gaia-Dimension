...
public class ModItems {
    ...
    public static final Item mutant_growth_extractor_spawn_egg = registerSpawnEgg("mutant_growth_extractor", ModEntities.growth_extractor, 0x5A4514, 0xFFFFCC);
    public static final Item howlite_wolf_spawn_egg = registerSpawnEgg("howlite_wolf", ModEntities.howlite_wolf, 0xDDDDDD, 0x3333FF);
    public static final Item spellbound_elemental_spawn_egg = registerSpawnEgg("spellbound_elemental", ModEntities.spell_elemental, 0x885555, 0xCC33CC);
