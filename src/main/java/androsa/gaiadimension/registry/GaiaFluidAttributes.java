...
public class GaiaFluidAttributes {
    ...
    public static final ForgeFlowingFluid.Properties mineral_water_properties =
            new ForgeFlowingFluid.Properties(ModFluids.mineral_water_still::get, ModFluids.mineral_water_flow::get, mineral_water_attributes)
    ...
    public static final ForgeFlowingFluid.Properties superhot_magma_properties =
            new ForgeFlowingFluid.Properties(ModFluids.superhot_magma_still::get, ModFluids.superhot_magma_flow::get, superhot_magma_attributes)
    ...
    public static final ForgeFlowingFluid.Properties sweet_muck_properties =
            new ForgeFlowingFluid.Properties(ModFluids.sweet_muck_still::get, ModFluids.sweet_muck_flow::get, sweet_muck_attrubutes)
    ...
    public static final ForgeFlowingFluid.Properties liquid_bismuth_properties =
            new ForgeFlowingFluid.Properties(ModFluids.liquid_bismuth_still::get, ModFluids.liquid_bismuth_flow::get, liquid_bismuth_attributes)
    ...
    public static final ForgeFlowingFluid.Properties liquid_aura_properties =
            new ForgeFlowingFluid.Properties(ModFluids.liquid_aura_still::get, ModFluids.liquid_aura_flow::get, liquid_aura_attributes)
