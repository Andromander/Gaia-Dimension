...
public class GDItemsRegister {
    ...
    public static void onRegisterItems(RegistryEvent.Register<Item> event) {
        ...
        items.register("carnelian_sword", new GDGenericSword(TOOL_CARNELIAN).setUnlocalizedName("carnelian_axe").setMaxStackSize(1));
        items.register("carnelian_pickaxe", new GDGenericPickaxe(TOOL_CARNELIAN).setUnlocalizedName("carnelian_pickaxe").setMaxStackSize(1));
        items.register("carnelian_axe", new GDCarnelianAxe(TOOL_CARNELIAN).setUnlocalizedName("carnelian_axe").setMaxStackSize(1));
        items.register("carnelian_shovel", new GDGenericShovel(TOOL_CARNELIAN).setUnlocalizedName("carnelian_shovel").setMaxStackSize(1));
        items.register("benitoite_sword", new GDGenericSword(TOOL_BENITOITE).setUnlocalizedName("benitoite_sword").setMaxStackSize(1));
        items.register("benitoite_pickaxe", new GDGenericPickaxe(TOOL_BENITOITE).setUnlocalizedName("benitoite_sword").setMaxStackSize(1));
        items.register("benitoite_axe", new GDBenitoiteAxe(TOOL_BENITOITE).setUnlocalizedName("benitoite_axe").setMaxStackSize(1));
        items.register("benitoite_shovel", new GDGenericShovel(TOOL_BENITOITE).setUnlocalizedName("benitoite_shovel").setMaxStackSize(1));
        items.register("chalcedony_sword", new GDGenericSword(TOOL_CHALCEDONY).setUnlocalizedName("chalcedony_sword").setMaxStackSize(1));
        items.register("chalcedony_pickaxe", new GDGenericPickaxe(TOOL_CHALCEDONY).setUnlocalizedName("chalcedony_pickaxe").setMaxStackSize(1));
        items.register("chalcedony_axe", new GDChalcedonyAxe(TOOL_CHALCEDONY).setUnlocalizedName("chalcedony_axe").setMaxStackSize(1));
        items.register("chalcedony_shovel", new GDGenericShovel(TOOL_CHALCEDONY).setUnlocalizedName("chalcedony_shovel").setMaxStackSize(1));

        items.register("sugilite_helmet", new GDSugiliteArmor(ARMOR_SUGILITE, HEAD).setUnlocalizedName("sugilite_helmet").setMaxStackSize(1));
        items.register("sugilite_chestplate", new GDSugiliteArmor(ARMOR_SUGILITE, CHEST).setUnlocalizedName("sugilite_chestplate").setMaxStackSize(1));
        items.register("sugilite_legs", new GDSugiliteArmor(ARMOR_SUGILITE, LEGS).setUnlocalizedName("sugilite_legs").setMaxStackSize(1));
        items.register("sugilite_boots", new GDSugiliteArmor(ARMOR_SUGILITE, FEET).setUnlocalizedName("sugilite_boots").setMaxStackSize(1));
        items.register("proustite_helmet", new GDProustiteArmor(ARMOR_PROUSTITE, HEAD).setUnlocalizedName("proustite_helmet").setMaxStackSize(1));
        items.register("proustite_chestplate", new GDProustiteArmor(ARMOR_PROUSTITE, CHEST).setUnlocalizedName("proustite_chestplate").setMaxStackSize(1));
        items.register("proustite_legs", new GDProustiteArmor(ARMOR_PROUSTITE, LEGS).setUnlocalizedName("proustite_legs").setMaxStackSize(1));
        items.register("proustite_boots", new GDProustiteArmor(ARMOR_PROUSTITE, FEET).setUnlocalizedName("proustite_boots").setMaxStackSize(1));
        items.register("leucite_helmet", new GDLeuciteArmor(ARMOR_LEUCITE, HEAD).setUnlocalizedName("leucite_helmet").setMaxStackSize(1));
        items.register("leucite_chestplate", new GDLeuciteArmor(ARMOR_LEUCITE, CHEST).setUnlocalizedName("leucite_chestplate").setMaxStackSize(1));
        items.register("leucite_legs", new GDLeuciteArmor(ARMOR_LEUCITE, LEGS).setUnlocalizedName("leucite_legs").setMaxStackSize(1));
        items.register("leucite_boots", new GDLeuciteArmor(ARMOR_LEUCITE, FEET).setUnlocalizedName("leucite_boots").setMaxStackSize(1));
        items.register("carnelian_helmet", new GDCarnelianArmor(ARMOR_CARNELIAN, HEAD).setUnlocalizedName("carnelian_helmet").setMaxStackSize(1));
        items.register("carnelian_chestplate", new GDCarnelianArmor(ARMOR_CARNELIAN, CHEST).setUnlocalizedName("carnelian_chestplate").setMaxStackSize(1));
        items.register("carnelian_legs", new GDCarnelianArmor(ARMOR_CARNELIAN, LEGS).setUnlocalizedName("carnelian_legs").setMaxStackSize(1));
        items.register("carnelian_boots", new GDCarnelianArmor(ARMOR_CARNELIAN, FEET).setUnlocalizedName("carnelian_boots").setMaxStackSize(1));
        items.register("diopside_helmet", new GDDiopsideArmor(ARMOR_DIOPSIDE, HEAD).setUnlocalizedName("diopside_helmet").setMaxStackSize(1));
        items.register("diopside_chestplate", new GDDiopsideArmor(ARMOR_DIOPSIDE, CHEST).setUnlocalizedName("diopside_chestplate").setMaxStackSize(1));
        items.register("diopside_legs", new GDDiopsideArmor(ARMOR_DIOPSIDE, LEGS).setUnlocalizedName("diopside_legs").setMaxStackSize(1));
        items.register("diopside_boots", new GDDiopsideArmor(ARMOR_DIOPSIDE, FEET).setUnlocalizedName("diopside_boots").setMaxStackSize(1));
        items.register("chalcedony_helmet", new GDChalcedonyArmor(ARMOR_CHALCEDONY, HEAD).setUnlocalizedName("chalcedony_helmet").setMaxStackSize(1));
        items.register("chalcedony_chestplate", new GDChalcedonyArmor(ARMOR_CHALCEDONY, CHEST).setUnlocalizedName("chalcedony_chestplate").setMaxStackSize(1));
        items.register("chalcedony_legs", new GDChalcedonyArmor(ARMOR_CHALCEDONY, LEGS).setUnlocalizedName("chalcedony_legs").setMaxStackSize(1));
        items.register("chalcedony_boots", new GDChalcedonyArmor(ARMOR_CHALCEDONY, FEET).setUnlocalizedName("chalcedony_boots").setMaxStackSize(1));
