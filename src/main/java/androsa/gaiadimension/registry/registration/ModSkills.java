...
public class ModSkills {
    ...
    //Counter: +1 attack after taking damage for 5 seconds.
    //Flinch: -2 attack after taking damage.
    public static final HoneSkill COUNTER = new HoneSkill(1, 2);
    public static final HoneSkill FLINCH = new HoneSkill(-1, 1);
    ...
    //Charger: +1 damage when attack cooldown is fully charged.
    //Spammer: -2 damage when attack cooldown is fully charged
    public static final HoneSkill CHARGER = new HoneSkill(1, 3);
    public static final HoneSkill SPAMMER = new HoneSkill(-1, 1);
    //Airborne: +2 damage when in the air (not on the ground).
    //Airsick: -3 damage when in the air (not on the ground).
    public static final HoneSkill AIRBORNE = new HoneSkill(1, 2);
    public static final HoneSkill AIRSICK = new HoneSkill(-1, 1);
