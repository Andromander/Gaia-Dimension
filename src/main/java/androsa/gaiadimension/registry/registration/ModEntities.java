...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AncientLagrahkEntity>> ANCIENT_LAGRAHK = registerEntity("ancient_lagrahk", AncientLagrahkEntity::new, MobCategory.MONSTER, 1.5F, 4.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<ArchaicWarriorEntity>> ARCHAIC_WARRIOR = registerEntity("archaic_warrior", ArchaicWarriorEntity::new, MobCategory.MONSTER, 0.6F, 1.95F, false);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CavernTickEntity>> CAVERN_TICK = registerEntity("cavern_tick", CavernTickEntity::new, MobCategory.MONSTER, 0.4F, 0.3F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<ContortedNagaEntity>> CONTORTED_NAGA = registerEntity("contorted_naga", ContortedNagaEntity::new, MobCategory.MONSTER, 1.0F, 2.6F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<CorruptSapperEntity>> CORRUPT_SAPPER = registerEntity("corrupt_sapper", CorruptSapperEntity::new, MobCategory.MONSTER, 1.0F, 1.0F, false);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GrowthSapperEntity>> GROWTH_SAPPER = registerEntity("growth_sapper", GrowthSapperEntity::new, MobCategory.CREATURE, 1.0F, 1.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<HowliteWolfEntity>> HOWLITE_WOLF = registerEntity("howlite_wolf", HowliteWolfEntity::new, MobCategory.CREATURE, 1.0F, 1.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<LesserShockshooterEntity>> LESSER_SHOCKSHOOTER = registerEntity("lesser_shockshooter", LesserShockshooterEntity::new, MobCategory.MONSTER, 0.5F, 2.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<LesserSpitfireEntity>> LESSER_SPITFIRE = registerEntity("lesser_spitfire", LesserSpitfireEntity::new, MobCategory.MONSTER, 0.5F, 2.0F, true);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MineralArenthisEntity>> MINERAL_ARENTHIS = registerEntity("mineral_arenthis", MineralArenthisEntity::new, MobCategory.WATER_CREATURE, 1.5F, 1.5F, false);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MutantGrowthExtractorEntity>> MUTANT_GROWTH_EXTRACTOR = registerEntity("mutant_growth_extractor", MutantGrowthExtractorEntity::new, MobCategory.CREATURE, 1.0F, 1.5F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<NomadicLagrahkEntity>> NOMADIC_LAGRAHK = registerEntity("nomadic_lagrahk", NomadicLagrahkEntity::new, MobCategory.CREATURE, 1.5F, 4.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<PrimalBeastEntity>> PRIMAL_BEAST = registerEntity("primal_beast", PrimalBeastEntity::new, MobCategory.MONSTER, 1.0F, 2.0F, true);
    public static final DeferredHolder<EntityType<?>, EntityType<RockyLuggerothEntity>> ROCKY_LUGGEROTH = registerEntity("rocky_luggeroth", RockyLuggerothEntity::new, MobCategory.CREATURE, 1.0F, 1.6F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<RuggedLurmorusEntity>> RUGGED_LURMORUS = registerEntity("rugged_lurmorus", RuggedLurmorusEntity::new, MobCategory.CREATURE, 3.5F, 8.0F, false);
    public static final DeferredHolder<EntityType<?>, EntityType<SaltionEntity>> SALTION = registerEntity("saltion", SaltionEntity::new, MobCategory.CREATURE, 1.0F, 0.3F, false);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ShalurkerEntity>> SHALURKER = registerEntity("shalurker", ShalurkerEntity::new, MobCategory.MONSTER, 0.6F, 1.9F, false);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GrowthGrazerEntity>> GROWTH_GRAZER = registerEntity("growth_grazer", GrowthGrazerEntity::new, MobCategory.CREATURE, 1.0F, 1.0F, false);
    ...
    //Mini Bosses
    public static final DeferredHolder<EntityType<?>, EntityType<BlueHowliteWolfEntity>> BLUE_HOWLITE_WOLF = registerEntity("blue_howlite_wolf", BlueHowliteWolfEntity::new, MobCategory.MONSTER, 1.2F, 2.2F, false);

    //Bosses
    public static final DeferredHolder<EntityType<?>, EntityType<MalachiteGuardEntity>> MALACHITE_GUARD = registerEntity("malachite_guard", MalachiteGuardEntity::new, MobCategory.MONSTER, 0.8F, 3.3F, false);
