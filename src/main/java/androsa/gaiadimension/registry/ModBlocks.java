...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> pink_agate_log = registerBlockGeneral("pink_agate_log", () -> new AgateLogBlock(MaterialColor.MAGENTA, MaterialColor.PINK_TERRACOTTA));
    public static final RegistryObject<Block> blue_agate_log = registerBlockGeneral("blue_agate_log", () -> new AgateLogBlock(MaterialColor.BLUE, MaterialColor.BLUE_TERRACOTTA));
    public static final RegistryObject<Block> green_agate_log = registerBlockGeneral("green_agate_log", () -> new AgateLogBlock(MaterialColor.GREEN, MaterialColor.LIME_TERRACOTTA));
    public static final RegistryObject<Block> purple_agate_log = registerBlockGeneral("purple_agate_log", () -> new AgateLogBlock(MaterialColor.PURPLE_TERRACOTTA, MaterialColor.PURPLE));
    public static final RegistryObject<Block> fossilized_log = registerBlockGeneral("fossilized_log", () -> new AgateLogBlock(MaterialColor.YELLOW, MaterialColor.DIRT));
    public static final RegistryObject<Block> corrupted_log = registerBlockGeneral("corrupted_log", () -> new AgateLogBlock(MaterialColor.TNT, MaterialColor.GRAY_TERRACOTTA));
    public static final RegistryObject<Block> burnt_log = registerBlockGeneral("burnt_log", () -> new AgateLogBlock(MaterialColor.GRAY, MaterialColor.BLACK_TERRACOTTA));
    public static final RegistryObject<Block> burning_log = registerBlockWithFuel("burning_log", () -> new AgateLogBlock(MaterialColor.ADOBE, MaterialColor.ORANGE_TERRACOTTA, 3), 1600);
    public static final RegistryObject<Block> aura_log = registerBlockGeneral("aura_log", () -> new AgateLogBlock(MaterialColor.IRON, MaterialColor.GRAY));
    public static final RegistryObject<Block> stripped_pink_agate_log = registerBlockGeneral("stripped_pink_agate_log", () -> new AgateLogBlock(MaterialColor.MAGENTA, MaterialColor.MAGENTA));
    public static final RegistryObject<Block> stripped_blue_agate_log = registerBlockGeneral("stripped_blue_agate_log", () -> new AgateLogBlock(MaterialColor.BLUE, MaterialColor.BLUE));
    public static final RegistryObject<Block> stripped_green_agate_log = registerBlockGeneral("stripped_green_agate_log", () -> new AgateLogBlock(MaterialColor.GREEN, MaterialColor.GREEN));
    public static final RegistryObject<Block> stripped_purple_agate_log = registerBlockGeneral("stripped_purple_agate_log", () -> new AgateLogBlock(MaterialColor.PURPLE_TERRACOTTA, MaterialColor.PURPLE_TERRACOTTA));
    public static final RegistryObject<Block> stripped_fossilized_log = registerBlockGeneral("stripped_fossilized_log", () -> new AgateLogBlock(MaterialColor.YELLOW, MaterialColor.YELLOW));
    public static final RegistryObject<Block> stripped_corrupted_log = registerBlockGeneral("stripped_corrupted_log", () -> new AgateLogBlock(MaterialColor.TNT, MaterialColor.TNT));
    public static final RegistryObject<Block> stripped_burnt_log = registerBlockGeneral("stripped_burnt_log", () -> new AgateLogBlock(MaterialColor.GRAY, MaterialColor.GRAY));
    public static final RegistryObject<Block> stripped_burning_log = registerBlockWithFuel("stripped_burning_log", () -> new AgateLogBlock(MaterialColor.ADOBE, MaterialColor.ADOBE, 3), 1600);
    public static final RegistryObject<Block> stripped_aura_log = registerBlockGeneral("stripped_aura_log", () -> new AgateLogBlock(MaterialColor.IRON, MaterialColor.IRON));
    public static final RegistryObject<Block> pink_agate_wood = registerBlockGeneral("pink_agate_wood", () -> new AgateLogBlock(MaterialColor.PINK_TERRACOTTA, MaterialColor.PINK_TERRACOTTA));
    public static final RegistryObject<Block> blue_agate_wood = registerBlockGeneral("blue_agate_wood", () -> new AgateLogBlock(MaterialColor.BLUE_TERRACOTTA, MaterialColor.BLUE_TERRACOTTA));
    public static final RegistryObject<Block> green_agate_wood = registerBlockGeneral("green_agate_wood", () -> new AgateLogBlock(MaterialColor.LIME_TERRACOTTA, MaterialColor.LIME_TERRACOTTA));
    public static final RegistryObject<Block> purple_agate_wood = registerBlockGeneral("purple_agate_wood", () -> new AgateLogBlock(MaterialColor.PURPLE, MaterialColor.PURPLE));
    public static final RegistryObject<Block> fossilized_wood = registerBlockGeneral("fossilized_wood", () -> new AgateLogBlock(MaterialColor.DIRT, MaterialColor.DIRT));
    public static final RegistryObject<Block> corrupted_wood = registerBlockGeneral("corrupted_wood", () -> new AgateLogBlock(MaterialColor.GRAY_TERRACOTTA, MaterialColor.GRAY_TERRACOTTA));
