...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> raw_jade = registerBlockGeneral("raw_jade", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.GREEN, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<Block> jade_bricks = registerBlockGeneral("jade_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.LIME, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> jade_brick_slab = registerBlockGeneral("jade_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.LIME, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> jade_brick_stairs = registerBlockGeneral("jade_brick_stairs", () -> new GaiaStairsBlock(jade_bricks));
    public static final RegistryObject<Block> cracked_jade_bricks = registerBlockGeneral("cracked_jade_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.LIME, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> cracked_jade_brick_slab = registerBlockGeneral("cracked_jade_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.LIME, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> cracked_jade_brick_stairs = registerBlockGeneral("cracked_jade_brick_stairs", () -> new GaiaStairsBlock(cracked_jade_bricks));
    public static final RegistryObject<Block> crusted_jade_bricks = registerBlockGeneral("crusted_jade_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.LIME, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> crusted_jade_brick_slab = registerBlockGeneral("crusted_jade_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.LIME, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> crusted_jade_brick_stairs = registerBlockGeneral("crusted_jade_brick_stairs", () -> new GaiaStairsBlock(crusted_jade_bricks));
    public static final RegistryObject<Block> raw_copal = registerBlockGeneral("raw_copal", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.GOLD, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<Block> copal_bricks = registerBlockGeneral("copal_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> copal_brick_slab = registerBlockGeneral("copal_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> copal_brick_stairs = registerBlockGeneral("copal_brick_stairs", () -> new GaiaStairsBlock(copal_bricks));
    public static final RegistryObject<Block> cracked_copal_bricks = registerBlockGeneral("cracked_copal_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> cracked_copal_brick_slab = registerBlockGeneral("cracked_copal_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> cracked_copal_brick_stairs = registerBlockGeneral("cracked_copal_brick_stairs", () -> new GaiaStairsBlock(cracked_copal_bricks));
    public static final RegistryObject<Block> crusted_copal_bricks = registerBlockGeneral("crusted_copal_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> crusted_copal_brick_slab = registerBlockGeneral("crusted_copal_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> crusted_copal_brick_stairs = registerBlockGeneral("crusted_copal_brick_stairs", () -> new GaiaStairsBlock(crusted_copal_bricks));
    public static final RegistryObject<Block> raw_jet = registerBlockGeneral("raw_jet", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.GRAY, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<Block> jet_bricks = registerBlockGeneral("jet_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.BLACK, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> jet_brick_slab = registerBlockGeneral("jet_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.BLACK, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> jet_brick_stairs = registerBlockGeneral("jet_brick_stairs", () -> new GaiaStairsBlock(jet_bricks));
    public static final RegistryObject<Block> cracked_jet_bricks = registerBlockGeneral("cracked_jet_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.BLACK, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> cracked_jet_brick_slab = registerBlockGeneral("cracked_jet_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.BLACK, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> cracked_jet_brick_stairs = registerBlockGeneral("cracked_jet_brick_stairs", () -> new GaiaStairsBlock(cracked_jet_bricks));
    public static final RegistryObject<Block> crusted_jet_bricks = registerBlockGeneral("crusted_jet_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.BLACK, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> crusted_jet_brick_slab = registerBlockGeneral("crusted_jet_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.BLACK, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> crusted_jet_brick_stairs = registerBlockGeneral("crusted_jet_brick_stairs", () -> new GaiaStairsBlock(crusted_jet_bricks));
    public static final RegistryObject<Block> raw_amethyst = registerBlockGeneral("raw_amethyst", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.PURPLE_TERRACOTTA, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<Block> amethyst_bricks = registerBlockGeneral("amethyst_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.PURPLE, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> amethyst_brick_slab = registerBlockGeneral("amethyst_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.PURPLE, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> amethyst_brick_stairs = registerBlockGeneral("amethyst_brick_stairs", () -> new GaiaStairsBlock(amethyst_bricks));
    public static final RegistryObject<Block> cracked_amethyst_bricks = registerBlockGeneral("cracked_amethyst_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.PURPLE, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> cracked_amethyst_brick_slab = registerBlockGeneral("cracked_amethyst_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.PURPLE, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> cracked_amethyst_brick_stairs = registerBlockGeneral("cracked_amethyst_brick_stairs", () -> new GaiaStairsBlock(cracked_amethyst_bricks));
    public static final RegistryObject<Block> crusted_amethyst_bricks = registerBlockGeneral("crusted_amethyst_bricks", () -> new BasicGaiaBlock(Material.ROCK, MaterialColor.PURPLE, 2.0F, 20.0F, PICKAXE, 1));
    public static final RegistryObject<SlabBlock> crusted_amethyst_brick_slab = registerBlockGeneral("crusted_amethyst_brick_slab", () -> new GaiaSlabBlock(Material.ROCK, MaterialColor.PURPLE, SoundType.STONE, 2.0F, 20.0F, PICKAXE, 1, 0));
    public static final RegistryObject<StairsBlock> crusted_amethyst_brick_stairs = registerBlockGeneral("crusted_amethyst_brick_stairs", () -> new GaiaStairsBlock(crusted_amethyst_bricks));
