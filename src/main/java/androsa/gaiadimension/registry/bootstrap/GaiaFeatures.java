...
public class GaiaFeatures extends GaiaBiomeFeatures {
    ...
    public static class Configured {
        ...
        public static final ResourceKey<ConfiguredFeature<?, ?>> ore_celestine = registerFeature("ore_celestine");
        ...
        public static void init(BootstapContext<ConfiguredFeature<?, ?>> context) {
            ...
            context.register(ore_celestine, oreFeature(PRIMAL, CELESTINE_ORE, 4));
    ...
    public static class Placed {
        ...
        public static final ResourceKey<PlacedFeature> ORE_CELESTINE = registerPlaced("ore_celestine");
        ...
        public static void init(BootstapContext<PlacedFeature> context) {
            ...
            context.register(ORE_CELESTINE, placedOre(features, Configured.ore_celestine, 0, 3));
