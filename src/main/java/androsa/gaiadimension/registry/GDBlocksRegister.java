...
public final class GDBlocksRegister {
    ...
    public static void onRegisterBlocks(RegistryEvent.Register<Block> event) {
        ...
        blocks.register("crusty_leaves", new GDAgateLeaves(() -> Items.GUNPOWDER));
        blocks.register("heated_leaves", (new GDAgateLeaves(() -> GDItems.hot_dust)).setLightLevel(0.3F));
        ...
        blocks.register("crusty_planks", new GDBlock(Material.WOOD, MapColor.BLACK, SoundType.STONE).setHardness(1.5F).setResistance(2.0F));
        blocks.register("heated_planks", new GDBlock(Material.WOOD, MapColor.ORANGE_STAINED_HARDENED_CLAY, SoundType.STONE).setHardness(1.5F).setResistance(2.0F).setLightLevel(0.5F));
        ...
        blocks.register("crusty_plank_stairs", new GDAgatePlankStairs(burntPlanks.getDefaultState()));
        blocks.register("heated_plank_stairs", new GDAgatePlankStairs(firePlanks.getDefaultState()).setLightLevel(0.5F));
        ...
        //Storage Blocks
        blocks.register("sugilite_block",    new GDBlock(Material.IRON, MapColor.PURPLE, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("hematite_block",    new GDBlock(Material.IRON, MapColor.GRAY, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("labradorite_block", new GDBlock(Material.IRON, MapColor.GREEN, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("opal_block_red",    new GDBlock(Material.IRON, MapColor.RED, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("opal_block_blue",   new GDBlock(Material.IRON, MapColor.LIGHT_BLUE, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("opal_block_green",  new GDBlock(Material.IRON, MapColor.LIME, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("opal_block_white",  new GDBlock(Material.IRON, MapColor.SNOW, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("pyrite_block",      new GDBlock(Material.IRON, MapColor.GOLD, SoundType.METAL).setHardness(5.0F).setResistance(10.0F).setLightLevel(1.0F));
        blocks.register("moonstone_block",   new GDBlock(Material.IRON, MapColor.SILVER, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("cinnabar_block",    new GDBlock(Material.IRON, MapColor.ADOBE, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("tektite_block",     new GDBlock(Material.IRON, MapColor.BLACK, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("goldstone_block",   new GDBlock(Material.IRON, MapColor.BLACK, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("ixiolite_block",    new GDBlock(Material.IRON, MapColor.GRAY, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("proustite_block",   new GDBlock(Material.IRON, MapColor.MAGENTA, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("euclase_block",     new GDBlock(Material.IRON, MapColor.LIME, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("leucite_block",     new GDBlock(Material.IRON, MapColor.SAND, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("carnelian_block",   new GDBlock(Material.IRON, MapColor.RED, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("benitoite_block",   new GDBlock(Material.IRON, MapColor.BLUE, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("diopside_block",    new GDBlock(Material.IRON, MapColor.LIME, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));
        blocks.register("chalcedony_block",  new GDBlock(Material.IRON, MapColor.SNOW, SoundType.METAL).setHardness(5.0F).setResistance(10.0F));

        //Ores
        blocks.register("sugilite_ore",    new GDOre(Material.ROCK, MapColor.PURPLE, () -> GDItems.sugilite).setHardness(4.0F).setResistance(25.0F));
        blocks.register("hematite_ore",    new GDOre(Material.ROCK, MapColor.GRAY, () -> GDItems.hematite).setHardness(4.0F).setResistance(25.0F));
        blocks.register("pyrite_ore",      new GDOre(Material.ROCK, MapColor.GOLD, () -> GDItems.pyrite).setHardness(4.0F).setResistance(25.0F));
        blocks.register("opal_ore_red",    new GDOre(Material.ROCK, MapColor.RED, () -> GDItems.red_opal).setHardness(4.0F).setResistance(25.0F));
        blocks.register("opal_ore_blue",   new GDOre(Material.ROCK, MapColor.LIGHT_BLUE, () -> GDItems.blue_opal).setHardness(4.0F).setResistance(25.0F));
        blocks.register("opal_ore_green",  new GDOre(Material.ROCK, MapColor.LIME, () -> GDItems.green_opal).setHardness(4.0F).setResistance(25.0F));
        blocks.register("opal_ore_white",  new GDOre(Material.ROCK, MapColor.SNOW, () -> GDItems.white_opal).setHardness(4.0F).setResistance(25.0F));
        blocks.register("labradorite_ore", new GDOre(Material.ROCK, MapColor.GREEN, () -> GDItems.labradorite).setHardness(4.0F).setResistance(25.0F));
        blocks.register("moonstone_ore",   new GDOre(Material.ROCK, MapColor.SILVER, () -> GDItems.moonstone).setHardness(4.0F).setResistance(25.0F));
        blocks.register("cinnabar_ore",    new GDOre(Material.ROCK, MapColor.ADOBE, () -> GDItems.cinnabar).setHardness(4.0F).setResistance(25.0F));
        blocks.register("speckled_rock",   new GDOre(Material.ROCK, MapColor.MAGENTA, null).setHardness(4.0F).setResistance(25.0F));
        blocks.register("coarse_rock",     new GDOre(Material.ROCK, MapColor.MAGENTA, null).setHardness(4.0F).setResistance(25.0F));
        blocks.register("precious_rock",   new GDOre(Material.ROCK, MapColor.MAGENTA, null).setHardness(4.0F).setResistance(25.0F));
