...
public final class GDBlocksRegister {
    ...
    public static void onRegisterBlocks(RegistryEvent.Register<Block> event) {
        ...
        blocks.register("purple_agate_plank_slab", new GDAgatePlankSlab(false, MapColor.PURPLE));
        blocks.register("fossilized_plank_slab", new GDAgatePlankSlab(false, MapColor.DIRT));
        ...
        blocks.register("double_purple_agate_plank_slab", new GDAgatePlankSlab(true, MapColor.PURPLE));
        blocks.register("double_fossilized_plank_slab", new GDAgatePlankSlab(true, MapColor.DIRT));
