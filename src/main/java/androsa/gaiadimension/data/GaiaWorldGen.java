...
public class GaiaWorldGen extends WorldGenerationProvider {
    ...
    private List<Pair<TerrainPoint, Holder<Biome>>> makeBiomeList(Registry<Biome> registry) {
        return List.of(
                ...
                pairBiome(registry, 0.75F, 0.15F, ModBiomes.golden_forest),
                pairBiome(registry, 1.0F, 0.5F, ModBiomes.golden_hills),
                pairBiome(registry, 0.55F, 0.05F, ModBiomes.golden_marsh),
                pairBiome(registry, 0.65F, 0.1F, ModBiomes.golden_plains),
                pairBiome(registry, 0.65F, 0.05F, ModBiomes.golden_sands),
