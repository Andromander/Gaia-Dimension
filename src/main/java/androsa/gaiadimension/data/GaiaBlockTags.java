...
public class GaiaBlockTags extends GaiaBlockTagsProvider {
    ...
    private static final ImmutableList<Block> BEACON_BASES = ImmutableList.of(
    ...
    private static final ImmutableList<Block> FLOWER_POTS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> GUARDED_BY_PIGLINS = ImmutableList.of(
            ModBlocks.crude_storage_crate, ModBlocks.mega_storage_crate
    );
    private static final ImmutableList<Block> IMPERMEABLE = ImmutableList.of(
            ModBlocks.foggy_glass, ModBlocks.cloudy_glass, ModBlocks.frail_glitter_block
    );
    private static final ImmutableList<Block> LEAVES = ImmutableList.of(
    ...
    private static final ImmutableList<Block> PURPLE_AGATE_LOGS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> SAPLINGS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> SLABS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> SMALL_FLOWERS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> STAIRS = ImmutableList.of(
    ...
    private static final ImmutableList<Block> DIRT = ImmutableList.of(
    ...
    protected void registerTags() {
        ...
        getOrCreateBuilder(BlockTags.NON_FLAMMABLE_WOOD).addTags(
                GaiaTags.Blocks.PINK_AGATE_LOGS, GaiaTags.Blocks.BLUE_AGATE_LOGS, GaiaTags.Blocks.GREEN_AGATE_LOGS, GaiaTags.Blocks.PURPLE_AGATE_LOGS,
                GaiaTags.Blocks.FOSSILIZED_LOGS, GaiaTags.Blocks.CORRUPTED_LOGS, GaiaTags.Blocks.BURNT_LOGS, GaiaTags.Blocks.BURNING_LOGS, GaiaTags.Blocks.AURA_LOGS);
        getOrCreateBuilder(BlockTags.PORTALS).add(ModBlocks.gaia_portal);
        ...
        getOrCreateBuilder(GaiaTags.Blocks.ORES_SUGILITE).add(ModBlocks.sugilite_ore);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_HEMATITE).add(ModBlocks.hematite_ore);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_CINNABAR).add(ModBlocks.cinnabar_ore);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_LABRADORITE).add(ModBlocks.labradorite_ore);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_MOONSTONE).add(ModBlocks.moonstone_ore);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_RED_OPAL).add(ModBlocks.opal_ore_red);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_BLUE_OPAL).add(ModBlocks.opal_ore_blue);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_GREEN_OPAL).add(ModBlocks.opal_ore_green);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_WHITE_OPAL).add(ModBlocks.opal_ore_white);
        getOrCreateBuilder(GaiaTags.Blocks.ORES_PYRITE).add(ModBlocks.pyrite_ore);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_SUGILITE).add(ModBlocks.sugilite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_HEMATITE).add(ModBlocks.hematite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_CINNABAR).add(ModBlocks.cinnabar_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_LABRADORITE).add(ModBlocks.labradorite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_MOONSTONE).add(ModBlocks.moonstone_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_RED_OPAL).add(ModBlocks.opal_block_red);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_BLUE_OPAL).add(ModBlocks.opal_block_blue);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_GREEN_OPAL).add(ModBlocks.opal_block_green);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_WHITE_OPAL).add(ModBlocks.opal_block_white);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_PYRITE).add(ModBlocks.pyrite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_TEKTITE).add(ModBlocks.tektite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_GOLDSTONE).add(ModBlocks.goldstone_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_AURA_CRYSTAL).add(ModBlocks.aura_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_BISMUTH).add(ModBlocks.bismuth_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_IXIOLITE).add(ModBlocks.ixiolite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_PROUSTITE).add(ModBlocks.proustite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_EUCLASE).add(ModBlocks.euclase_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_LEUCITE).add(ModBlocks.leucite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_CARNELIAN).add(ModBlocks.carnelian_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_BENITOITE).add(ModBlocks.benitoite_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_DIOPSIDE).add(ModBlocks.diopside_block);
        getOrCreateBuilder(GaiaTags.Blocks.STORAGE_BLOCKS_CHALCEDONY).add(ModBlocks.chalcedony_block);
        addTag(GaiaTags.Blocks.TILES, TILES);

        addTag(Tags.Blocks.DIRT, DIRT);
        getOrCreateBuilder(Tags.Blocks.GLASS).add(ModBlocks.foggy_glass, ModBlocks.cloudy_glass);
        ...
        getOrCreateBuilder(GaiaTags.Blocks.STATIC).add(ModBlocks.gaia_stone, ModBlocks.wasteland_stone);
        getOrCreateBuilder(GaiaTags.Blocks.VOLCANIC).add(ModBlocks.gaia_stone, ModBlocks.volcanic_rock);
