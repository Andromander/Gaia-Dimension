...
public class GaiaBlockTags extends GaiaBlockTagsProvider {
    ...
    public static final ImmutableList<Supplier<? extends Block>> LEAVES = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> PINK_AGATE_LOGS = ImmutableList.of(
            ModBlocks.pink_agate_log, ModBlocks.stripped_pink_agate_log, ModBlocks.pink_agate_wood, ModBlocks.stripped_pink_agate_wood
    );
    public static final ImmutableList<Supplier<? extends Block>> BLUE_AGATE_LOGS = ImmutableList.of(
            ModBlocks.blue_agate_log, ModBlocks.stripped_blue_agate_log, ModBlocks.blue_agate_wood, ModBlocks.stripped_blue_agate_wood
    );
    public static final ImmutableList<Supplier<? extends Block>> GREEN_AGATE_LOGS = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> PURPLE_AGATE_LOGS = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> SAPLINGS = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> SLABS = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> STAIRS = ImmutableList.of(
    ...
    public static final ImmutableList<Supplier<? extends Block>> GAIA_BRICKS = ImmutableList.of(
            ModBlocks.gaia_stone_bricks, ModBlocks.cracked_gaia_stone_bricks, ModBlocks.crusted_gaia_stone_bricks
    );
    public static final ImmutableList<Supplier<? extends Block>> AMETHYST_BRICKS = ImmutableList.of(
            ModBlocks.amethyst_bricks, ModBlocks.cracked_amethyst_bricks, ModBlocks.crusted_amethyst_bricks
    );
    public static final ImmutableList<Supplier<? extends Block>> COPAL_BRICKS = ImmutableList.of(
            ModBlocks.copal_bricks, ModBlocks.cracked_copal_bricks, ModBlocks.crusted_copal_bricks
    );
    public static final ImmutableList<Supplier<? extends Block>> JADE_BRICKS = ImmutableList.of(
            ModBlocks.jade_bricks, ModBlocks.cracked_jade_bricks, ModBlocks.crusted_jade_bricks
    );
    public static final ImmutableList<Supplier<? extends Block>> JET_BRICKS = ImmutableList.of(
    ...
    private static final ImmutableList<Supplier<? extends Block>> PICKAXE_TOOL = ImmutableList.of(
            ...
            ModBlocks.malachite_pillar_stairs, ModBlocks.scaynyx_block, ModBlocks.sugilite_block, ModBlocks.hematite_block, ModBlocks.cinnabar_block, ModBlocks.labradorite_block, ModBlocks.moonstone_block, ModBlocks.red_opal_block,
    ...
    private static final ImmutableList<Supplier<? extends Block>> NEEDS_STONE = ImmutableList.of(
            ...
            ModBlocks.amethyst_bricks, ModBlocks.amethyst_brick_stairs, ModBlocks.amethyst_brick_slab, ModBlocks.cracked_amethyst_bricks, ModBlocks.cracked_amethyst_brick_stairs, ModBlocks.cracked_amethyst_brick_slab,
            ModBlocks.crusted_amethyst_bricks, ModBlocks.crusted_amethyst_brick_stairs, ModBlocks.crusted_amethyst_brick_slab, ModBlocks.scaynyx_block
    );
    ...
    protected void addTags(HolderLookup.Provider provider) {
        (new GaiaBlockItemTags() {
            ...
            protected TagAppender<Block, Block> tag(TagKey<Block> blocktag, TagKey<Item> itemtag) {
                return GaiaBlockTags.this.tag(blocktag);
            }
        }).run();
