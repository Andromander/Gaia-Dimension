    ...
    public static class Advancements implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider provider, Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
            ...
            Advancement progress1 = Advancement.Builder.advancement()
                    ...
                    .addCriterion("mini_tower", PlayerTrigger.TriggerInstance.located(LocationPredicate.inStructure(GaiaConfiguredStructures.mini_tower.unwrapKey().orElseThrow())))
            ...
            Advancement progress2 = Advancement.Builder.advancement()
                    ...
                    .addCriterion("malachite_watchtower", PlayerTrigger.TriggerInstance.located(LocationPredicate.inStructure(GaiaConfiguredStructures.malachite_watchtower.unwrapKey().orElseThrow())))
