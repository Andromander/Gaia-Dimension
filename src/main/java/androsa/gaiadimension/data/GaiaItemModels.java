...
public class GaiaItemModels extends GaiaItemModelProvider {
    ...
    protected void registerModels() {
        ...
        blockItem(ModBlocks.celestine_ore);
        ...
        basicItem(ModItems.blank_kit);
        basicItem(ModItems.repair_kit);
        basicItem(ModItems.scarlet_augment_kit);
        basicItem(ModItems.auburn_augment_kit);
        basicItem(ModItems.gold_augment_kit);
        basicItem(ModItems.mauve_augment_kit);
        basicItem(ModItems.beige_augment_kit);
        basicItem(ModItems.ivory_augment_kit);
        basicItem(ModItems.scarlet_replace_kit);
        basicItem(ModItems.auburn_replace_kit);
        basicItem(ModItems.gold_replace_kit);
        basicItem(ModItems.mauve_replace_kit);
        basicItem(ModItems.beige_replace_kit);
        basicItem(ModItems.ivory_replace_kit);
