...
public class GaiaItemModels extends GaiaItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.agate_stick);
        ...
        basicItem(ModItems.agate_sword);
        basicItem(ModItems.agate_pickaxe);
        basicItem(ModItems.agate_axe);
        basicItem(ModItems.agate_shovel);
        basicItem(ModItems.sugilite_sword);
        basicItem(ModItems.sugilite_pickaxe);
        basicItem(ModItems.sugilite_axe);
        basicItem(ModItems.sugilite_shovel);
        basicItem(ModItems.ixiolite_sword);
        basicItem(ModItems.ixiolite_pickaxe);
        basicItem(ModItems.ixiolite_axe);
        basicItem(ModItems.ixiolite_shovel);
        basicItem(ModItems.euclase_sword);
        basicItem(ModItems.euclase_pickaxe);
        basicItem(ModItems.euclase_axe);
        basicItem(ModItems.euclase_shovel);
        basicItem(ModItems.carnelian_sword);
        basicItem(ModItems.carnelian_pickaxe);
        basicItem(ModItems.carnelian_axe);
        basicItem(ModItems.carnelian_shovel);
        basicItem(ModItems.benitoite_sword);
        basicItem(ModItems.benitoite_pickaxe);
        basicItem(ModItems.benitoite_axe);
        basicItem(ModItems.benitoite_shovel);
        basicItem(ModItems.chalcedony_sword);
        basicItem(ModItems.chalcedony_pickaxe);
        ...
        basicItem(ModItems.spinel_princess_flamberge);
        basicItem(ModItems.zircon_prince_razor);
        basicItem(ModItems.corrupt_warrior_sword);
        basicItem(ModItems.gaia_duchess_khopesh);
        basicItem(ModItems.gaia_baron_dagger);
        basicItem(ModItems.gaia_duke_blade);
        basicItem(ModItems.gaia_champion_sword);
