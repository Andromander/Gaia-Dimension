...
public class GaiaLootTables extends LootTableProvider {
    ...
    public static class Blocks extends GaiaBlockLootTableProvider {
        ...
        protected void addTables() {
            ...
            dropChance(ModBlocks.fossilized_leaves, ModBlocks.fossilized_sapling, leaf_chances);
            dropChance(ModBlocks.corrupted_leaves, ModBlocks.corrupted_sapling, leaf_chances);
            dropChance(ModBlocks.burnt_leaves, ModBlocks.burnt_sapling, leaf_chances);
            dropChance(ModBlocks.burning_leaves, ModBlocks.burning_sapling, leaf_chances);
