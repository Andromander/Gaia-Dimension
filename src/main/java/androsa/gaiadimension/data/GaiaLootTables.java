...
public class GaiaLootTables extends LootTableProvider {
    ...
    @Override
    protected void validate(WritableRegistry<LootTable> writableregistry, ValidationContextSource validationcontext, ProblemReporter.Collector collector) {
    }
    ...
    public static class Blocks extends GaiaBlockLootTableProvider {
        ...
        protected void generate() {
            ...
            dropTable(ModBlocks.tall_golden_grass, (block) -> this.doubleShearsOnly(block, ModBlocks.golden_grass.get()));
            ...
            dropSelf(ModBlocks.pink_calcite);
            dropSelf(ModBlocks.red_calcite);
            dropSelf(ModBlocks.blue_calcite);
            dropSelf(ModBlocks.light_blue_calcite);
            dropSelf(ModBlocks.green_calcite);
            dropSelf(ModBlocks.purple_calcite);
            dropSelf(ModBlocks.beige_calcite);
            dropSelf(ModBlocks.yellow_calcite);
            dropSelf(ModBlocks.black_calcite);
            dropSelf(ModBlocks.orange_calcite);
            dropSelf(ModBlocks.navy_calcite);
            dropSelf(ModBlocks.gold_calcite);
            dropSelf(ModBlocks.white_calcite);
            dropSelf(ModBlocks.clear_calcite);
            dropSelf(ModBlocks.pink_aragonite);
            dropSelf(ModBlocks.blue_aragonite);
            dropSelf(ModBlocks.light_blue_aragonite);
            dropSelf(ModBlocks.green_aragonite);
            dropSelf(ModBlocks.purple_aragonite);
            dropSelf(ModBlocks.tan_aragonite);
            dropSelf(ModBlocks.yellow_aragonite);
            dropSelf(ModBlocks.black_aragonite);
            dropSelf(ModBlocks.brown_aragonite);
            dropSelf(ModBlocks.white_aragonite);
            dropSelf(ModBlocks.clear_aragonite);
            dropSelf(ModBlocks.smooth_pink_calcite);
            dropSelf(ModBlocks.smooth_red_calcite);
            dropSelf(ModBlocks.smooth_blue_calcite);
            dropSelf(ModBlocks.smooth_light_blue_calcite);
            dropSelf(ModBlocks.smooth_green_calcite);
            dropSelf(ModBlocks.smooth_purple_calcite);
            dropSelf(ModBlocks.smooth_beige_calcite);
            dropSelf(ModBlocks.smooth_yellow_calcite);
            dropSelf(ModBlocks.smooth_black_calcite);
            dropSelf(ModBlocks.smooth_orange_calcite);
            dropSelf(ModBlocks.smooth_navy_calcite);
            dropSelf(ModBlocks.smooth_gold_calcite);
            dropSelf(ModBlocks.smooth_white_calcite);
            dropSelf(ModBlocks.smooth_clear_calcite);
            dropSelf(ModBlocks.smooth_pink_aragonite);
            dropSelf(ModBlocks.smooth_blue_aragonite);
            dropSelf(ModBlocks.smooth_light_blue_aragonite);
            dropSelf(ModBlocks.smooth_green_aragonite);
            dropSelf(ModBlocks.smooth_purple_aragonite);
            dropSelf(ModBlocks.smooth_tan_aragonite);
            dropSelf(ModBlocks.smooth_yellow_aragonite);
            dropSelf(ModBlocks.smooth_black_aragonite);
            dropSelf(ModBlocks.smooth_brown_aragonite);
            dropSelf(ModBlocks.smooth_white_aragonite);
            dropSelf(ModBlocks.smooth_clear_aragonite);
