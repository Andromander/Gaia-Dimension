...
public class ConstructCharmItem extends Item {
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity entity, InteractionHand hand) {
        if (entity instanceof MookaiteConstructEntity || entity instanceof OpaliteContructEntity) {
            ...
            if (entity instanceof MookaiteConstructEntity mookaite) {
                ...
                if (this.getUUID(stack, "MookaiteUUID") == null) {
                    ...
                    if (mookaite.getOpaliteCompanion() == null) {
                        ...
                        player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.mookaite_already_bonded"), true);
                        return InteractionResult.PASS;
                    }
                } else {
                    player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.has_mookaite_bond"), true);
                    return InteractionResult.PASS;
                }
            }
            ...
            if (entity instanceof OpaliteContructEntity opalite) {
                ...
                if (this.getUUID(stack, "OpaliteUUID") == null) {
                    ...
                    if (opalite.getMookaiteCompanion() == null) {
                        ...
                        player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.opalite_already_bonded"), true);
                        return InteractionResult.PASS;
                    }
                } else {
                    player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.has_opalite_bond"), true);
                    return InteractionResult.PASS;
                }
            }
            ...
            if (this.getUUID(stack, "MookaiteUUID") != null && this.getUUID(stack, "OpaliteUUID") != null) {
                ...
                if (mFlag && oFlag) {
                    ...
                    if (mFlag && oFlag) {
                        ...
                        player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.success"), true);
                        return InteractionResult.CONSUME;
                    } else {
                        if (!mFlag && !oFlag) {
                            player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.both_invalid"), true);
                        } else if (!mFlag) {
                            player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.mookaite_invalid"), true);
                        } else if (!oFlag) {
                    ...
                    if (!mFlag && !oFlag) {
                        player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.both_out_of_range"), true);
                    } else if (!mFlag) {
                        player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.mookaite_out_of_range"), true);
                    } else if (!oFlag) {
            ...
            player.displayClientMessage(Component.translatable("gaiadimension.construct_charm.message.invalid_entity"), true);
            return InteractionResult.PASS;
        }
