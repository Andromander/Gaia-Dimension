...
public class GaiaDukeSwordItem extends SwordItem {
    ...
    public GaiaDukeSwordItem(IItemTier material) {
        super(material, 3, -3.0F, new Properties().maxStackSize(1).defaultMaxDamage(material.getMaxUses()).rarity(Rarity.RARE).group(ModItemGroups.GAIA_TOOLS));
    }
