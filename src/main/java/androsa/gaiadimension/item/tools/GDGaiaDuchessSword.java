...
public class GDGaiaDuchessSword extends ItemSword implements ModelRegisterCallback {

    public GDGaiaDuchessSword(Item.ToolMaterial material) {
        super(material);
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND) {
            ...
            multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(), new AttributeModifier(ATTACK_SPEED_MODIFIER, "Weapon modifier", -2.2, 0)); //Speed is set to 1.8; 0.2 less than normal
        }
