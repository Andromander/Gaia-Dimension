...
public class GemPouchInventory implements IInventory, INamedContainerProvider {
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        ...
        return item != ModItems.gemstone_pouch.get() || Block.getBlockFromItem(item) != ModBlocks.crude_storage_crate.get() || Block.getBlockFromItem(item) != ModBlocks.mega_storage_crate.get();
    }
