...
public class SoftGrassBlock extends AbstractGaiaGrassBlock {
    ...
    public void performBonemeal(ServerLevel worldIn, RandomSource rand, BlockPos pos, BlockState state) {
        ...
        Optional<Holder.Reference<PlacedFeature>> optional = worldIn.registryAccess().lookupOrThrow(Registries.PLACED_FEATURE).get(GaiaFeatures.Placed.CRYSTAL_GROWTH_AURA);
