...
public class LargeCrateBlock extends BasicGaiaBlock {

    public static final ResourceLocation NAME = new ResourceLocation("contents");

    public LargeCrateBlock() {
        super(Material.ROCK, MaterialColor.PURPLE_TERRACOTTA, 10.0F, 300.0F, ToolType.AXE, 0);
    }
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (tileentity instanceof LargeCrateTileEntity) {
            LargeCrateTileEntity largecratetileentity = (LargeCrateTileEntity)tileentity;
            if (!worldIn.isRemote && player.isCreative() && !largecratetileentity.isEmpty()) {
                ...
                if (largecratetileentity.hasCustomName()) {
                    itemstack.setDisplayName(largecratetileentity.getCustomName());
                }
                ...
                largecratetileentity.fillWithLoot(player);
            }
        }
    ...
    public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
        ...
        if (tileentity instanceof LargeCrateTileEntity) {
            ...
            builder = builder.withDynamicDrop(NAME, (loot, stack) -> {
                for(int i = 0; i < largecratetileentity.getSizeInventory(); ++i) {
                    stack.accept(largecratetileentity.getStackInSlot(i));
                }
            });
        }
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        ...
        LargeCrateTileEntity largecratetileentity = (LargeCrateTileEntity)worldIn.getTileEntity(pos);
        CompoundNBT compoundnbt = largecratetileentity.saveToNbt(new CompoundNBT());
        if (!compoundnbt.isEmpty()) {
            itemstack.setTagInfo("BlockEntityTag", compoundnbt);
        }
