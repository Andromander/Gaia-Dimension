...
public class GDSpecialLog extends BlockLog implements ModelRegisterCallback {

    public static final PropertyEnum<SpecialGaiaLogVariant> VARIANT = PropertyEnum.create("variant", SpecialGaiaLogVariant.class);
    ...
    public IBlockState getStateFromMeta(int meta) {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, SpecialGaiaLogVariant.values()[meta & 3]);
