...
public class TileEntitySmallCrate extends TileEntityLockableLoot implements ISidedInventory {
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
        return new ContainerSmallCrate(playerInventory, this);
    }

    @Override
    public String getGuiID() {
        return "gaiadimension:small_crate";
    }

    @Override
    public String getName() {
        return hasCustomName() ? customName : "container.gaiadimension.small_crate";
    }
    ...
    public boolean canInsertItem(int index, ItemStack itemStackIn, EnumFacing direction) {
        return !(Block.getBlockFromItem(itemStackIn.getItem()) instanceof GDCrateSmall);
    }
